...
import { View ,Text, Button, ImageBackground,TextInput, TouchableOpacity, FlatList  , navigate} from 'react-native';
...
const Customer = ({navigation}) => {
  ...
  const [customer,setCustomer] = useState([
    { date: 'madhur mu', morningMilk:2 , eveningMilk:3 , houseName_No:'295-A' ,street:'11',society:'Raijibaug', city:'Junagadh',state:'Gujarat'},
  ]);
      ...
      <ImageBackground source={bgimage} style={globalstyles.imagecontainer}>
        ...
        <View style={styles.workingcontainer}>
          {/* <View> */}
            ...
            <TextInput style={styles.entermilk}
        ...
        <TextInput style={styles.Reportcontainer}
